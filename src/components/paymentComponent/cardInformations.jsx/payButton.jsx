...
const PayButton = ({total,onClick}) => {
    ...
    return (
        <button className="pay-btn" onClick = {onClick}>
            ...
            <span className="btn-text">Payer {numberFormatter.format(Number.parseFloat(total) + extraCost.allExtraCost)}€</span>
            <div className="icon-container">
                <svg viewBox="0 0 24 24" className="icon card-icon">
                    <path
                        d="M20,8H4V6H20M20,18H4V12H20M20,4H4C2.89,4 2,4.89 2,6V18C2,19.11 2.89,20 4,20H20C21.11,20 22,19.11 22,18V6C22,4.89 21.11,4 20,4Z"
